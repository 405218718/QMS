...
#
#
# # #  da = date.drop_duplicates(subset=['异常单编码'], keep='first', inplace=False)
# # # #当keep=False时，就是去掉所有的重复行;‘first'时，就是保留第一次出现的重复行;'last'时就是保留最后一次出现的重复行。
# # # #inplace:默认值False表示生成一个副本
#
#
#
#
